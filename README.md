            ...
            <Table style={styles.table}>
                <TableHead style={styles.tableHead}>
                    <TableRow>
                        ...
                        <TableCell style={styles.tableCell}>Pool</TableCell>
                        <TableCell style={styles.tableCell}>Att/Succ %</TableCell>
                        <TableCell style={styles.tableCell}>Status</TableCell>
                        <TableCell style={styles.tableCell}>Green</TableCell>
                        <TableCell style={styles.tableCell}>Yellow</TableCell>
                        <TableCell style={styles.tableCell}>Orange</TableCell>
                        <TableCell style={styles.tableCell}>Red</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
