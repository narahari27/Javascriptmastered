            ...
            <Table style={styles.tableTop}>
                <TableHead style={styles.tableHead}>
                    <TableRow>
                        ...
                        <TableCell style={styles.tableCellCentered}>{node.nodetype === "smsf" ? "Nrf Support" : node.nodetype === "vepdg"? "OOR" : "RC"}</TableCell>
                ...
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell style={getRCStyle(node?.stats?.RC_Value?.att || node?.stats?.OOR?.att || node?.stats?.RC?.att)}>{node.nodetype === "vepdg"? node?.stats?.OOR?.att || "null" : node?.stats?.ModelD ? (node?.stats?.ModelD.att === "true"? "InService" : "ORR") : node?.stats?.RC_Value?.att || node?.stats?.RC?.att || 0}</TableCell>
